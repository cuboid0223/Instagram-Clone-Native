...
"a800353d-5ceb-4ad4-847b-32ed1296f418" 
mutation user4 {
  createUser(input: {name: "Cuboid", image: "https://avatars.githubusercontent.com/u/59163273?s=60&v=4"}) {
    id
    name
  }
}
...
mutation post2 {
  createPost(input: {userID: "a800353d-5ceb-4ad4-847b-32ed1296f418" ,likes: 12,caption: "Check this out", image: "https://cdnuploads.aa.com.tr/uploads/Contents/2020/05/14/thumbs_b_c_88bedbc66bb57f0e884555e8250ae5f9.jpg?v=140708"}) {
    id
    image
    caption
    user {
...
mutation post3 {
  createPost(input: {userID: "2ecea834-61f8-4370-9a12-f6d761ace58f" , likes: 180,caption: "Like3Likes", image: "https://i.insider.com/5d03aa8e6fc9201bc7002b43?width=1136&format=jpeg"}) {
    id
    image
    caption
    user {
...
mutation story3 {
  createStory(input: {userID: "2ecea834-61f8-4370-9a12-f6d761ace58f", image: "https://upload.wikimedia.org/wikipedia/commons/0/0f/Eiffel_Tower_Vertical.JPG"}) {
    id
    image
    user {
      name
...
mutation story4 {
  createStory(input: {userID: "a800353d-5ceb-4ad4-847b-32ed1296f418"  image: "https://images.unsplash.com/photo-1526512340740-9217d0159da9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80"}) {
    id
    image
    user {
      name
