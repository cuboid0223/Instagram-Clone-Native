...
const Stories = () => {
  const data = [
    ...
    {
      imageUri:
        'https://instagram.ftpe1-3.fna.fbcdn.net/v/t51.2885-19/11007912_807640775983280_1278253375_a.jpg?_nc_ht=instagram.ftpe1-3.fna.fbcdn.net&_nc_ohc=cGheB_9JzloAX9ersnC&oh=75391c6149d52ee1f7a2ed958c05904a&oe=60376657',
      name: 'marvel',
    },
    {
      imageUri:
